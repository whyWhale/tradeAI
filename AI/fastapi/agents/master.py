...
master_template = """당신은 비트코인 시장의 투자 분석 전문가입니다.
    ...
    최대한 BUY나 SELL을 하도록 해주세요.
    현재 가지고 있는 비트코인 원화 금액을 고려해서({btc_balance_krw}) 너무 적다면 BUY를 적극적으로 고려해주세요.
