  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <FirstContainer className="flex gap-10">
        ...
        <LoginImage className="flex flex-end w-[1200px] h-[1000px] relative top-[-20%]" src="/images/trai_figma.png" alt="image"/>
      </FirstContainer>
      ...
      <ThirdContainer>
        ...
        <FAQItem question="TRAI 서비스는 무엇인가요?" answer="TRAI는 대규모 언어 모델(LLM)을 기반으로 가상화폐 시장을 분석하여 거래 전략을 제안하는 AI 서비스입니다. LLM을 활용하여 시장 데이터를 심층적으로 분석하고, 다양한 패턴과 트렌드를 포착하여 더 나은 거래 결정을 지원합니다." />
        <FAQItem question="현재 왜 관전자 모드만 가능한가요?" answer="TRAI는 가상화폐 시장의 리스크와 변동성을 고려하여, 사용자들에게 안전하게 거래 전략을 관찰하고 학습할 수 있는 환경을 제공하기 위해 설계되었습니다. TRAI의 핵심 목표는 거래에 대한 깊은 이해와 통찰을 제공하는 것이며, 사용자 자산을 직접 관리하는 것보다는 독립적인 분석과 전략을 지원하는 데 중점을 두고 있습니다." />
        <FAQItem question="TRAI가 지원하는 가상화폐는 무엇인가요?" answer="현재 TRAI는 비트코인에 대한 거래 전략 분석을 지원합니다. 다른 가상화폐는 지원하지 않습니다." />
        <FAQItem question="TRAI를 사용하면 얼마나 수익을 기대할 수 있나요?" answer="TRAI의 AI는 시장 데이터를 기반으로 최적의 거래 전략을 제시하지만, 수익을 보장하지는 않으며, 모든 투자에는 위험이 따릅니다." />
        <FAQItem question="TRAI 사용 방법" answer="TRAI를 사용하려면 회원가입 후 관전자 모드로 접속하여 AI가 제안하는 거래 전략을 확인할 수 있습니다. 이를 통해 가상화폐 시장에 대한 이해를 높이고, AI 기반의 거래 분석 과정을 경험해 보세요." />
