...
const Firework = () => {
  ...
  useEffect(() => {
    ...
    const createTail = () => {
      const x = randomNumBetween(window.innerWidth * 0.2, window.innerWidth * 0.8);
    ...
    const createParticles = (x, y, colorDeg) => {
      ...
      for (let i = 0; i < PARTICLE_NUM; i++) {
        ...
        particles.current.push(new Particle(ctx, x, y, vx, vy, opacity, _colorDeg));
      }
    };
